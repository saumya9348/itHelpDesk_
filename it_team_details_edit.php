    ...
    <div class="bodysection">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="edit_it_team">
                    <form action="it_team_details_update_code.php" method="post">
                        
                        <?php
                            $cmd2="select * from it_team_details where teamid=".$_GET['id'];
                            $details=$connection->query($cmd2);
                            foreach($details as $v2){

                            }
                            
                        ?>
                        <input type="hidden" name="tmid" id="" value="<?php echo $v2['teamid']; ?>">
                        Employee Name <input type="text" name="empnm" id="" value="<?php echo $v2['tempname']; ?>"><br><br>
                        User Name <input type="text" name="usernm" id="" value="<?php echo $v2['tusername']; ?>"><br><br>
                        Password <input type="password" name="pwd" id="" value="<?php echo $v2['tpassword']; ?>"><br><br>
                        Mobile No <input type="text" name="mobno" id="" value="<?php echo $v2['tmobno']; ?>"><br><br>
                        Status <select name="teamstatus" id="">
                                    <?php
                                        if($v2['status']=="Active"){
                                    ?>
                        ...
                        Email Id <input type="text" name="emlid" id="" value="<?php echo $v2['tmailid']; ?>"><br><br>
                        <input type="submit" name="" id="" value="Update"> &nbsp; <button><a href="it_team_details.php">Cancel</a></button>
