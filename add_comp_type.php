    ...
    <div class="bodysection">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="addnew_complain">
                    <h3>Add New Complain</h3>
                    <form action="add_comp_type_code.php" method="post">
                        <h4>Complain Type</h4>
                        <input type="text" name="newcomp" id=""><br><br>
                        <input type="submit" name="" id="" value="Save"> &nbsp; <input type="reset" value="Reset">
                    </form>
                </div>
                <br><br><br><br>
                <div class="comp_types">
                <form action="">
                    <table class="table">
                        <thead >
                            <tr>
                        ...
                        <tbody>
                            <?php
                                $cmd3="select * from complain_type";
                                $c=$connection->query($cmd3);
                                $j=1;
                                foreach($c as $v3){
                            ?>
                            <tr scope="row">
                                ...
                                <td><?php echo $j++ ; ?></td>
                                <td><?php echo $v3['comptype']; ?></td>
                                <td><?php echo $v3['compstatus']; ?></td>
                                <td><a href="add_comp_type_edit.php"><i class="fa fa-pencil"></i></a> &nbsp; <a href="add_comp_type_delete.php?id=<?php echo $v3['complainid']; ?>" ><i class="fa fa-trash"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
