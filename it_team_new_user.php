    ...
    <div class="bodysection">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <form action="it_team_new_user_code.php" method="post">
                    <div class="new_it_team_user">
                        Employee Name <input type="text" name="empnm" id=""><br><br>
                        User Name <input type="text" name="usernm" id=""><br><br>
                        Password <input type="password" name="pwd" id=""><br><br>
                        Mobile No <input type="text" name="mobno" id=""><br><br>
                        Email Id <input type="text" name="emlid" id=""><br><br>
                        <input type="submit" name="" id=""> &nbsp; <button><a href="it_team_details.php">Cancel</a></button>
                    </div>
                </form>
            </div>
        </div>
