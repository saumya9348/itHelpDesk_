    ...
    <div class="bodysection">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="comp_reports">
                    <button><a href="user_complain.php">Add New Complain</a></button>
                    <div class="report_table">
                        ...
                        <thead>
                            ...
                            <?php
                                    ...
                                    inner join it_team_details itmd on ucd.it_team_id = itmd.teamid";
                            ...
                            ?>
                                <tr scope="row">
                                    ...
                                    <td scope="col"><?php echo $v2['tempname']; ?></td>
                                    <td scope="col"><?php echo $v2['comp_dt']; ?></td>
                                    <td scope="col"><?php echo $v2['comp_status']; ?></td>
                                    <td scope="col"><a href="user_complain_id_dlt.php?cid=<?php echo $v2['user_comp_id'] ;?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
