    ...
    <div class="bodysection">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="chng_pw">
                        <form action="chang_pw_code.php" method="post">
                        <?php
                                if(isset($_SESSION['pw_match'])){
                                ?>
                                <h3 style="color:red;text-shadow:1px 1px 20px blue;"><?php echo $_SESSION['pw_match']; unset($_SESSION['pw_match']); ?></h3>
                                <?php } ?>
                            Old Password <input type="text" name="oldpw" id=""> <br><br>
                            New Password <input type="text" name="newpw" id="">  <br><br>
                            <input type="submit" value="Update"> <input type="reset" name="" id="" value="Reset">
                        </form>
