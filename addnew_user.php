    ...
    <div class="bodysection">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="newuser">
                    <form action="addnew_user_insert_code.php" method="post">

                        Department &nbsp;<select name="deptmnt" id="">
                             
                                    <option value="">Select Department</option>
                                    <?php 
                                        $cmd1="select * from departmentname";
                                        $qry1=$connection->query($cmd1);
                                        foreach($qry1 as $v2){

                                    ?>
                                    <option value="<?php echo $v2['did']; ?>"><?php echo $v2['dname']; ?></option>
                                    <?php } ?>
                                  </select><br><br>
                        Employee Name &nbsp;<input type="text" name="empnm" id=""> <br><br>
                        Employee System IP Adress &nbsp;<input type="text" name="empsysid" id=""> <br><br>
                        System Name &nbsp;<input type="text" name="sysnm" id=""> <br><br>
                        Mobile No &nbsp;<input type="text" name="mbno" id=""><br><br>
                        Email Id &nbsp;<input type="text" name="emlid" id=""><br><br>
